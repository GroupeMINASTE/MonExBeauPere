...
class Gift {
    ...
    static let library = [
        ...
        Gift(15, name: "Nathan Fallet", value: 1_000, kind: .person),
        Gift(16, name: "Bruno Paiva", value: 100, kind: .person),
        Gift(17, name: "Cédric Loneux", value: 100, kind: .person),
        Gift(18, name: "Léo Duff", value: 10_000, kind: .person),
        ...
        Gift(43, name: "un MacBook Pro M2 Max", value: 3_699, kind: .other),
        Gift(44, name: "un iPad Pro M2", value: 1_069, kind: .other),
        Gift(45, name: "un iPhone 14 Pro Max 512 GB Noir sidéral", value: 1_869, kind: .other),
        Gift(46, name: "un coffret saint-émillion de 3 bouteilles", value: 89, kind: .food),
        Gift(47, name: "une bougie à la cerise", value: 9, kind: .other),
        Gift(48, name: "une pizza", value: 15, kind: .food),
        Gift(49, name: "des pâtes à la carbonara", value: 15, kind: .food),
        Gift(50, name: "Coffret tripel karmeliet", value: 30, kind: .food),
        Gift(51, name: "LaTeX Cards", value: 250, kind: .entertainment),
        Gift(52, name: "une paire de chaussettes", value: 2, kind: .other),
        Gift(53, name: "une box de fromages dégustation", value: 29, kind: .food),
        Gift(54, name: "Un pistolet à eau", value: 250, kind: .entertainment),
        Gift(55, name: "Une Nintendo Switch OLED", value: 319, kind: .entertainment),
        Gift(56, name: "Une carte Pokémon Dracaufeu", value: 418_000, kind: .entertainment),
        Gift(57, name: "Purplecliffe", value: 100_000, kind: .person),
        Gift(58, name: "Jonathan Weber", value: 10_000, kind: .person),
        Gift(59, name: "Kilian Aiello", value: 100, kind: .person),
        Gift(60, name: "Crystal", value: 0, kind: .person),
        Gift(61, name: "Gaspard", value: 100, kind: .person),
        Gift(62, name: "Diplay", value: 100, kind: .person),
        Gift(63, name: "Draco", value: 100, kind: .person)
    ]
